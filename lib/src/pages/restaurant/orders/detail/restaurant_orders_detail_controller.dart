...
import 'package:hotel/src/models/address.dart';
import 'package:hotel/src/models/order.dart';
import 'package:hotel/src/models/product.dart';
import 'package:hotel/src/models/response_api.dart';
import 'package:hotel/src/models/user.dart';
import 'package:hotel/src/pages/restaurant/orders/payments/restaurant_orders_payments_page.dart';
import 'package:hotel/src/provider/address_provider.dart';
import 'package:hotel/src/provider/orders_provider.dart';
...
class RestaurantOrdersDetailController{
  ...
  void sendNotification(String tokenClient) {
    ...
    pushNotificationsProvider.sendMessage(
        ...
        data,
        'RESERVACIÓN EXITOSA',
        'Se ha reservado exitosamente tu habitación '
    );
  }
