...
import 'package:hotel/src/pages/restaurant/orders/detail/restaurant_orders_detail_controller.dart';
import 'package:hotel/src/utils/my_colors.dart';
import 'package:hotel/src/utils/relative_time_util.dart';
import 'package:hotel/src/widgets/no_data_widget.dart';
...
class _RestaurantOrdersDetailPageState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Reservación  #${_con.order?.id ?? ''}'),
        actions: [
          Container(
